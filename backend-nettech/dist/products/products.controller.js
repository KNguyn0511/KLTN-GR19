...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Xem chi tiết 1 sản phẩm' }),
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Thêm sản phẩm mới vào kho' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Cập nhật số lượng tồn kho (Nhập/Xuất)' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Xóa sản phẩm khỏi kho' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
