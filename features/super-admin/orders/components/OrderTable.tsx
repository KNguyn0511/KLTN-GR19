...
import { Globe, Store, MoreHorizontal, CreditCard, Wallet, QrCode, Banknote, Package } from "lucide-react";
...
export function getPaymentMethodBadge(method: string | undefined) {
  ...
  if (m === "VNPAY") {
    return (
      <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-50 px-2.5 py-1 text-[10px] font-black uppercase tracking-tight text-blue-600 ring-1 ring-blue-100">
  ...
  if (m === "MOMO") {
    return (
      <span className="inline-flex items-center gap-1.5 rounded-full bg-pink-50 px-2.5 py-1 text-[10px] font-black uppercase tracking-tight text-pink-600 ring-1 ring-pink-100">
  ...
  if (m === "BANK_TRANSFER") {
    return (
      <span className="inline-flex items-center gap-1.5 rounded-full bg-purple-50 px-2.5 py-1 text-[10px] font-black uppercase tracking-tight text-purple-600 ring-1 ring-purple-100">
        <QrCode className="h-3 w-3" /> QR CODE
      </span>
    );
  }
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full bg-amber-50 px-2.5 py-1 text-[10px] font-black uppercase tracking-tight text-amber-600 ring-1 ring-amber-100">
